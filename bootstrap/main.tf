        ...
        Condition = {
          StringEquals = {
            ...
            "token.actions.githubusercontent.com:sub" = [
              "repo:huss-osman@170414499/it-tools-fargate-platform@1338670631:ref:refs/heads/main",
              "repo:huss-osman@170414499/it-tools-fargate-platform@1338670631:pull_request"
            ]
          }
        }
      }
